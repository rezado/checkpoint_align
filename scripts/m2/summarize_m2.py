...
def main() -> int:
    catalog_path = ROOT / "data" / "results" / "dwarf-source" / "catalog-summary.json"
    controlled_path = ROOT / "data" / "results" / "m2" / "results" / "validation-summary.json"
    real_path = ROOT / "data" / "results" / "m2" / "results" / "libquantum-small" / "validation-summary.json"
    shifted_path = ROOT / "data" / "results" / "m3" / "shifted-candidate-review.json"
    ...
    output = ROOT / "data" / "results" / "m2" / "validation-summary.json"
